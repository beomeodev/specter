...
6. **Remain risk-blind.** Do not read Verification signals, the
   verification-v2 config, or a station receipt, and do not infer a risk
   profile. This baseline must remain independent of the decomposition and
   its risk metadata.
