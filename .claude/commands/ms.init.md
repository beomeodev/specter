...
-   Creates directory structure:
    ...
    -   `.specify/templates/` - Template files (including constitution-template.md)
...
Copy `templates/constitution-template.md` to `.specify/memory/constitution.md`:
...
-   Display error: "Constitution template missing. Expected: templates/constitution-template.md"
