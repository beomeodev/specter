...
-   `/ms.analyze` Level 2 validates test coverage ≥80% (CI/CD blocking)
-   Coverage < 80% blocks `/ms.implement` execution

**Exceptions**: None. This is an absolute rule.

**Metrics**: Minimum 80% test coverage across the codebase.
...
-   [ ] Tests: Coverage ≥80%, all passing (unit + integration)
